---
title: Python 并发：进程、线程、协程，从语言机制到工程选型
date: 2026-04-11
categories: 技术
tags:
- Python
...
文中示例代码来自我的示例仓库 [`minniexcode/Python_review`](https://github.com/minniexcode/Python_review) 里的两个脚本：

- [`2026-review/process-thread.py`](https://github.com/minniexcode/Python_review/blob/master/2026-review/process-thread.py)
- [`2026-review/async-io.py`](https://github.com/minniexcode/Python_review/blob/master/2026-review/async-io.py)
